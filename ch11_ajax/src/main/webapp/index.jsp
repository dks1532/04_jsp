...
<body>
	...
	<p>
		...
		* 동기식 / 비동기식<br>
		> 동기식(a, form, submit)
		<ul>
			<li>요청 처리후 그에 해당하는 응답페이지가 돌아와야만 그 다음 작업 가능</li>
		...
		<ul>
			...
			<li>요청을 보내놓고 그에 해당하는 응답(데이터)가 돌아올때까지 현재페이지에서 다른작업을 할 수 있음</li>
			<li>페이지가 깜박거리지 않음</li>
		</ul>
		ex) 실시간 검색어 로딩, 검색어 자동 완성기능, 아이디 중복체크, 찜하기/해제하기, 추천, 댓글, 무한스크롤<p/>
		
		* 비동기식의 단점<br>
		- 현재 페이지에 지속적으로 리소스가 쌓임 => 페이지가 느려질 수 있음<br>
		- 에러 발생시 디버깅 어려움<br>
		- 요청 처리후에 돌아온 응답데이터를 가지고 현재페이지에 새로운 요소를 만들어서 출력해야 됨<br>
		 => dom요소를 새롭게 만들어내는 구문을 잘 익혀둬야됨<p/>
