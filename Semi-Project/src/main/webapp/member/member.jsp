...
<body>
	<form name="regFrm" method ="post" action="memberProc.jsp">
		<table align="center" class="table table-bordered">
			<tr>
				<th colspan="3" class="blockquote text-center text-white bg-dark">회원가입</th>
			</tr>
			<tr>
				<td>아이디</td>
				<td>
			...
			<tr>
				<th colspan="3" class="text-center">
					<input type="button" value="회원가입" onclick="inputCheck();" class="btn btn-secondary">&emsp;
					<input type="reset" value="다시쓰기" class="btn btn-danger">&emsp;
					<input type="button" value="로그인" onclick="location.href='login.jsp'" class="btn btn-secondary">&emsp;
					<input type="button" value="홈으로" onclick="location.href='../index.jsp'" class="btn btn-secondary">
				</th>
			</tr>
		</table>
	</form>
