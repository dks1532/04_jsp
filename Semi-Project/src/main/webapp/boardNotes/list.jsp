<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.*, boardNotes.*" %>   
...
<body>
	<h2 align="center">필기노트</h2>
	<table align="center" width="700px" class="table table-striped table-dark">
		...
		<%
			ArrayList<BoardBean> alist = nMgr.getBoardList(keyField, keyWord, start, end);
			listSize = alist.size();
